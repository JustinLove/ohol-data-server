...
ActiveRecord::Schema.define(version: 2022_04_02_161158) do
  ...
  create_table "lives", force: :cascade do |t|
    ...
    t.index ["lineage", "chain"], name: "index_lives_on_lineage_and_chain"
  ...
  create_table "names", force: :cascade do |t|
    t.string "name"
    t.index ["name"], name: "index_name_on_names", opclass: :gist_trgm_ops, using: :gist
    t.index ["name"], name: "unique_name_on_names", unique: true
  end
